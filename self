...
proxies:
  ...
  - name: anyapp2
    ...
    ws-path: /
    ws-headers:
      Host: anyapp2.xj3017.workers.dev
  - name: anyapp3
    server: 104.16.133.43
    port: 443
    type: vmess
    uuid: 123fd54f-35ec-4e78-92ab-c0a23c5f95e8
    alterId: 64
    cipher: auto
    tls: true
    skip-cert-verify: false
    ...
    ws-path: /
    ws-headers:
      Host: anyapp3.xj3017.workers.dev
  - name: anyapp4
    server: 104.16.131.34
    port: 443
    type: vmess
    uuid: 40c3d050-e5cf-4f4d-90d3-55e482598c86
    alterId: 64
    cipher: auto
    tls: true
    skip-cert-verify: false
    ...
    ws-path: /
    ws-headers:
      Host: anyapp4.xj3017.workers.dev
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
